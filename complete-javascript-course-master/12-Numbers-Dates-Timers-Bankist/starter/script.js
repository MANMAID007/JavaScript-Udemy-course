...
// labelDate.textContent = `${year}-${month}-${date} ${hr}:${min}`;
...
//   console.log(`checking the value n: ${n}`);
//   const power = n ** m;
//   for (let i = 1; i <= m; i++) {
//     setTimeout(() => console.log(`${i} seconds goes away`), i * 1000);
//   }
//   return setTimeout(
//     () => console.log(`finally!!! the result is ${power}`),
//     (m + 1) * 1000
//   );
// };
// f(20, 20);
